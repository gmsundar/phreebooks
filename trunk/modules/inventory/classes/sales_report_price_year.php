...
// +-----------------------------------------------------------------+
//  Path: /modules/inventory/classes/sales_report_price_year.php
//
...
class sales_report_price_year {
	...
	function load_report_data($report, $Seq, $sql, $GrpField) {
		...
		$sql = $temp_sql[0] .", journal_item.sku, sum(journal_item.credit_amount) as qty FROM " . $temp_sql[1];
